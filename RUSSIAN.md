...
> Effector — библиотека для управления потоками данных в приложениях на TypeScript и JavaScript.

Нашли крутую статью, видео или подкаст на русском? Пожалуйста, **[отправьте нам PullRequest](contributing.md)**!
